...
const PLANS: PlanData[] = [
  {
    ...
    popular:  false,
    features: [
      "AI bilan mustaqil o'rganish",
      "Har kuni shaxsiy mashq va topshiriqlar",
      "AI avtomatik tekshiradi va baholaydi",
      "Mastery dashboard (qizil/sariq/yashil)",
      "Telegram kunlik eslatmalar",
      "Streak va badge tizimi",
    ],
  },
  {
    name:     "Standard",
    ...
    popular:  true,
    features: [
      "Haftada 3 kun jonli dars (real o'qituvchi)",
      "Guruhda maksimal 12 talaba",
      "AI bilan kunlik mashq",
      "Writing feedback (AI + o'qituvchi)",
      "Mock imtihon va natija tahlili",
      "Xalqaro imtihonga tayyorgarlik",
    ],
  },
  {
    name:     "Premium",
    ...
    popular:  false,
    features: [
      "Intensiv: haftada 3 kun jonli dars",
      "Guruhda 1-3 talaba (individual yondashuv)",
      "Shaxsiy o'qituvchi bilan to'liq qo'llab-quvvatlash",
      "AI bilan cheksiz mashq",
      "Xalqaro imtihonga kafolatli tayyorgarlik",
      "Goethe / telc / TestDaF sertifikat yo'li",
    ],
  },
]
